...
import com.github.johnsonmoon.java2excel.core.entity.custom.annotation.Column;
...
import com.github.johnsonmoon.java2excel.core.operation.custom.CustomImporter;
...
public abstract class CustomAbstractEditor {
	 ...
	 * @return true/false
	 */
	protected boolean writeColumnMapperHeader(Class<?> clazz, Workbook workbook, int sheetNumber,
			String sheetName) {
	 ...
	 * @return true/false
	 */
	protected boolean writeData(List<?> tList, ColumnMapper columnMapper, Workbook workbook, int sheetNumber,
			int startRowNumber) {
		if (tList == null || tList.isEmpty()) {
			throw new RuntimeException("tList is empty or null.");
		}
