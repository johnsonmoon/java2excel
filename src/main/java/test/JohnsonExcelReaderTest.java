...
public class JohnsonExcelReaderTest {
    ...
    public static void main(String[] args) {
        try {
            // 对读取Excel表格标题测试
            File file = new File("E:\\JUnitTestPath\\ImportFileTest.xls");
            if (!file.exists()){
                try{
                    file.createNewFile();
            ...
            // 对读取Excel表格内容测试
            File file2 = new File("E:\\JUnitTestPath\\ImportFileTest.xls");
            FileInputStream fileInputStream2 = new FileInputStream(file2);
            Map<Integer, String> map = excelReader.readExcelContent(fileInputStream2);
